...
class UpdatePayrollProfileRequest extends FormRequest
{
    public function authorize(): bool
    {
        ...
        return $hasFinanceRole && (
            ...
            || ($user?->can('edit_salary_structure') ?? false)
        );
    }

    public function rules(): array
    {
        $profile = $this->route('payrollProfile');
        $profileId = $profile instanceof PayrollProfile ? $profile->id : null;
        ...
        return [
            'user_id' => [
                ...
                Rule::unique('payroll_profiles', 'user_id')->ignore($profileId),
            ],
