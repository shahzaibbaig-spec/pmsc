<x-app-layout>
    ...
    <div class="mx-auto max-w-7xl space-y-6 py-8">
        ...
        <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            <form method="GET" action="{{ route('principal.discipline-reports.index') }}" class="grid grid-cols-1 gap-4 md:grid-cols-4">
                <div>
                ...
                <div class="md:col-span-4 flex flex-wrap gap-2">
                    ...
                    <a href="{{ route('principal.discipline-reports.index') }}" class="inline-flex min-h-11 items-center rounded-xl border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-50">Reset</a>
                </div>
            </form>
        </section>
        ...
        <section class="grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-7">
            ...
            <article class="rounded-2xl border border-red-200 bg-red-50 p-4 shadow-sm"><p class="text-xs font-semibold uppercase text-red-700">Urgent</p><p class="mt-2 text-2xl font-semibold text-red-800">{{ number_format((int) ($cards['urgent'] ?? 0)) }}</p></article>
        </section>
