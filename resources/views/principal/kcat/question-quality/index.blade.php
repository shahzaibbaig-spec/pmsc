<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold text-slate-900">KCAT Question Quality Analytics</h2>
    </x-slot>
                ...
                <tbody class="divide-y divide-slate-100">
                    @forelse ($questions as $question)
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-3 text-right"><a href="{{ route('principal.kcat.question-quality.show', $question) }}" class="font-semibold text-blue-700">View</a></td>
                        </tr>
                    @empty
