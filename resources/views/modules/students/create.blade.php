        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <form method="POST" action="{{ route('admin.students.store') }}" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        @csrf
                        ...
                        <div>
                            ...
                            <x-text-input id="age" name="age" type="number" min="1" max="100" class="mt-1 block w-full" :value="old('age')" />
                        </div>
                        ...
                        <div class="md:col-span-2 flex items-center gap-3">
                            ...
                            <a href="{{ route('admin.students.index') }}" class="rounded-md border border-gray-300 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">Back to List</a>
                        </div>
                    </form>
                </div>
            </div>
