...
<head>
    <meta charset="UTF-8">
    <title>Class Fee Challans {{ $meta['class_name'] ?? 'Class' }}</title>
    <style>
        ...
        .class-meta { margin-bottom: 10px; font-size: 11px; color: #4b5563; }
    </style>
</head>
<body>
    @foreach($payloads as $data)
        <div class="wrapper">
            <div class="class-meta">
                ...
                Month: {{ $meta['month_label'] ?? ($meta['month'] ?? '-') }} |
                Total Challans: {{ $meta['total_challans'] ?? 0 }}
            </div>
