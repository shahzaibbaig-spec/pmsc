...
<head>
    ...
    <style>
        body { font-family: DejaVu Sans, Arial, sans-serif; margin: 22px; color: #0f172a; }
        .card { border: 2px solid #0f172a; border-radius: 10px; padding: 16px; }
        .top { width: 100%; border-collapse: collapse; margin-bottom: 12px; }
        .top td { vertical-align: top; }
        .logo { width: 74px; height: 74px; object-fit: contain; }
        .title { text-align: center; }
        .school { margin: 0; font-size: 21px; font-weight: 700; }
        .subtitle { margin: 4px 0 0 0; font-size: 13px; }
        .badge { display: inline-block; margin-top: 6px; border: 1px solid #0f172a; border-radius: 999px; padding: 3px 10px; font-size: 11px; font-weight: 700; }
